...
public class MethodTests extends JerseyTest {
    ...
    private void setTestMode(boolean active) {
        if (active){
            MyMovieConfig.filepath = Paths.get(System.getProperty("user.home"), "it1901", "mmt", "serverfiles", "testserver-movielist.json");
        }
    }
    ...
    public void testLoadMovieList(){
        try {
            ...
            assertNotNull(list);
            assertEquals(List.of("James Bond", "Harry Potter", "Spider Man"), access.loadMovieList());
        } catch (Exception e) {
    ...
    public void testAddMovie(){
        try {
            ...
            assertEquals(List.of("James Bond", "Harry Potter", "Spider Man", "Avengers"), access.loadMovieList());
        } catch (Exception e) {
            // TODO: handle exception
        }
    }
    ...
    public void testUpdateMovie(){
        try {
            ...
            assertEquals(List.of("James Bond", "Harry Potter", "Spider Man","Dune"), access.loadMovieList());
        } catch (Exception e) {
            // TODO: handle exception
        }
    }
