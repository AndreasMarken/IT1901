...
public class RatingTest {
    ...
    public void testConstructor() {
        ...
        Assertions.assertEquals("Good movie", rating2.getComment(), "The comment does not match the comment that was given to the constructor.");
    ...
    public void testSetValidRating() {
        ...
        Assertions.assertEquals(rating2.getRating(), rating1.getRating(), "The rating do not match the rating that it was given");
    ...
    public void testSetNonValidRating() {
        ...
        Assertions.assertEquals(6, rating1.getRating(), "The rating should not change when an illegal argument is given");
    ...
    public void testSetValidComment() {
        ...
        Assertions.assertEquals("Well, it wasnt that good.", rating1.getComment(), "The new comment was not assigned when it should have been.");

        rating2.setComment("Very good.");
        Assertions.assertEquals("Very good.", rating2.getComment(), "It should be possible to assign a value to both Rating objects.");
